...
public class AddDataFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        EditText productNameEditText = root.findViewById(R.id.id);
        EditText productTypeEditText = root.findViewById(R.id.name);
        EditText productCountEditText = root.findViewById(R.id.quantity);
